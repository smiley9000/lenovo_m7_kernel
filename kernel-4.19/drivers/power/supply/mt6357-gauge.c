...
/*Huaqin add for AX3207-1029  by wangqi at 2021.06.03 start*/
...
/*Huaqin add for AX3207-1029  by wangqi at 2021.06.03 end*/
...
static int get_charger_zcv_ga(struct mtk_gauge *gauge_dev)
{
	...
	struct mtk_gauge_sysfs_field_info *attr, int *val)
{
	...
	tmp_hwocv_chgin = get_charger_zcv_ga(gauge_dev);
