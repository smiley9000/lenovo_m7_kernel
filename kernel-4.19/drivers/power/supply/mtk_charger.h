...
#define CHARGING_HOST_CHARGER_CURRENT		150000
...
enum temp_level_enum {
	TEMP_COLD_LEVEL = 0,  /*       temp <=  0C */
	TEMP_COOL_LEVEL,      /*  0C < temp <= 15C */
	TEMP_NORMAL_LEVEL,    /* 15C < temp <= 45C */
	TEMP_WARM_LEVEL,      /* 45C < temp <= 50c */
	TEMP_HOT_LEVEL        /*       temp >  50C */
};
