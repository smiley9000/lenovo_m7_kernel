...
/* AX3207 code for AX3207-815 by wangqi at 20201231 start */
		printk("%d",prop.intval);
		if(prop.intval>=-9 && prop.intval<=0 ){
			prop.intval = -10;
		}
/* AX3207 code for AX3207-815 by wangqi at 20201231 end */
		ret = prop.intval / 10;
	}
