...
/*add meta 3s power off for AX3207-14 by hulitao at 2020/10/16 Begin*/
#include <linux/reboot.h>
#include <linux/sched.h>
#include <linux/kthread.h>
/*add meta 3s power off for AX3207-14 by hulitao at 2020/10/16 end*/
		...
		const struct mtk_pmic_regs *pmic_regs)
{
	...
	if (ret || mtk_pmic_get_boot_mode() == RECOVERY_BOOT)
