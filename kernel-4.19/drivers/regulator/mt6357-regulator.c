...
/*wifi mode is close pmic vmidem for AX3207-498 by hulitao at 2020/10/27 Begin*/
#ifdef CONFIG_VMODEM_DIS_WIFI_MODE
		regmap_update_bits(mt6397->regmap, MT6357_BUCK_VMODEM_OP_EN, 0xF, 0x1);
		regmap_update_bits(mt6397->regmap, MT6357_BUCK_VMODEM_CON0 , 0x1, 0x0);
#endif
/*wifi mode is close pmic vmidem for AX3207-498 by hulitao at 2020/10/27 end*/
