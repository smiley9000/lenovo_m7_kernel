...
static const struct of_device_id lcm_platform_of_match[] = {
    {
        .compatible = "icnl,icnl9706_dsi_vdo",
        .data = 0,
    }, {
         /* sentinel */
    }
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	{0xF0, 2,{0x5A,0x5A}},
	{0xF1, 2,{0xA5,0xA5}},
	{0xB0,12,{0x21,0x21,0x21,0x21,0x11,0x11,0x11,0x11,0x04,0x0A,0x78,0x20}},
	{0xB1, 8,{0x11,0x44,0x02,0x85,0x04,0x0A,0x78,0x20}},
	{0xB3, 6,{0x0D,0x0D,0x0F,0x0F,0x05,0x05}},
	{0xB4, 6,{0x0C,0x0C,0x0E,0x0E,0x04,0x04}},
	//{0xB6, 2,{0x41,0x41//VCOM}},
	{0xB7,17,{0x01,0x41,0x09,0x11,0x0D,0x15,0x19,0x1D,0x21,0x1D,0x00,0x00,0x20,0x00,0x02,0xFF,0x3C}},
	{0xB8, 5,{0x24,0x01,0x30,0x35,0x53}},
	{0xBA, 2,{0x88,0x63}},
	{0xBD, 7,{0x4E,0x0E,0x42,0x42,0x20,0x1A,0x00}},
	{0xC1, 6,{0x0C,0x10,0x04,0x14,0x14,0x04}},
	{0xC2, 2,{0x81,0x10}},
	{0xC3, 3,{0x22,0x31,0x04}},
	{0xC6, 8,{0x00,0x00,0xFF,0x00,0x00,0xFF,0x00,0x00}},
	{0xC7, 5,{0x36,0x28,0x6B,0x49,0x00}},
	{0xC8,38,{0x7C,0x6A,0x5C,0x51,0x4F,0x41,0x46,0x31,0x4A,0x49,0x49,0x67,0x55,0x5D,0x4F,0x4B,0x3D,0x2A,0x06,0x7C,0x6A,0x5C,0x51,0x4F,0x41,0x46,0x31,0x4A,0x49,0x49,0x67,0x55,0x5D,0x4F,0x4B,0x3D,0x2A,0x06}},
	{0xD0, 3,{0x07,0xFF,0xFF}},
	{0xD2, 4,{0x62,0x0A,0x08,0x98}},
	{0xF0, 2,{0xA5,0xA5}},
	{0xF1, 2,{0x5A,0x5A}},
	{REGFLAG_DELAY,5,{}},
	{0x11, 0, {0x00}},
...
static void lcm_init_lcm(void)
{
	...
	printk("[Kernel/LCM] ---lcm_init--icnl9706--\n");
...
{
	printk("%s, select icnl9706_600hd_dsi_vdo_boe\n", __func__);
   return 1;
}

struct LCM_DRIVER icnl9706_600hd_dsi_vdo_boe_lcm_drv = {
	.name = "icnl9706_600hd_dsi_vdo_boe",
