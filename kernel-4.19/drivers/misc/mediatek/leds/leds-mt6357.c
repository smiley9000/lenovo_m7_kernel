...
/* AX3207 code for AX3207-643 by miaozhichao at 20201130 start */
//ISINK Step
#define ISINK_CH1_STEP						MT6357_ISINK1_CON1
#define ISINK_CH1_STEP_MASK			        0x7
#define ISINK_CH1_STEP_SHIFT				13
#define ISINK_CH1_STEP_MAX					0x7
/* AX3207 code for AX3207-643 by miaozhichao at 20201130 end */
//ISINK mode
...
/* AX3207 code for AX3207-531 by miaozhichao at 20201202 start */
#define ISINK_DIM1_FSEL_MAX_FREQ			500
/* AX3207 code for AX3207-531 by miaozhichao at 20201202 end */
...
static int mt6357_led_set_pwm_dim_freq(struct mt_led_info *info, int freq)
{
  ...
  /* AX3207 code for AX3207-531 by miaozhichao at 20201210 start */
	value = freq;
  /* AX3207 code for AX3207-531 by miaozhichao at 20201210 end */
	//PWM Frequency
	switch (led->id) {
	case MT6357_ISINK1:
...
static int mt6357_led_probe(struct platform_device *pdev)
{
	...
	const struct of_device_id *of_id =
		of_match_device(mt6357_led_dt_match, &pdev->dev);
