...
extern unsigned int hi556_read_otpdata(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);


struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	/*Below is commom sensor */
	{HI556_SENSOR_ID, 0xA0, hi556_read_otpdata},
