...
#endif
#if defined(GC02M1REAR_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC02M1REAR_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(GC2375HREAR_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC2375HREAR_MIPI_RAW,
		{
			{PDN, Vol_High, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(OV02B10REAR_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV02B10REAR_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
