...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1REAR_SENSOR_ID,
...
static kal_uint16 gc02m1rear_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_gc02m1rear[] = {
...
kal_uint16 addr_data_pair_preview_gc02m1rear[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1rear[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1rear[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1rear[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1rear[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1rear_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1rear,
		sizeof(addr_data_pair_init_gc02m1rear) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1rear_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1rear,
		sizeof(addr_data_pair_preview_gc02m1rear) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1rear_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1rear,
		sizeof(addr_data_pair_capture_gc02m1rear) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1rear_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1rear,
		sizeof(addr_data_pair_normal_video_gc02m1rear) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1rear_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1rear,
		sizeof(addr_data_pair_hs_video_gc02m1rear) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1rear_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1rear,
		sizeof(addr_data_pair_slim_video_gc02m1rear) /
		sizeof(kal_uint16));
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				hq_regiser_hw_info(HWID_MAIN_CAM, "chengxiangtong gc02m1-rear 2m");
...
UINT32 GC02M1REAR_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
