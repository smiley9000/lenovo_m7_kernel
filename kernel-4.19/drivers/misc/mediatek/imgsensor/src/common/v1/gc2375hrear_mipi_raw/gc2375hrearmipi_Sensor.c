...
#include "gc2375hrearmipi_Sensor.h"

/**************** Modify Following Strings for Debug ******************/
#define PFX "gc2375hrear_camera_sensor"
#define LOG_1 cam_pr_debug("GC2375HREAR, MIPI 1LANE\n")
/********************   Modify end    *********************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375HREAR_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375HREAR_MIRROR);
	...
	write_cmos_sensor(0x4e, GC2375HREAR_BLK_Select1_H);
	write_cmos_sensor(0x4f, GC2375HREAR_BLK_Select1_L);
	write_cmos_sensor(0x66, GC2375HREAR_BLK_Select2_H);
	write_cmos_sensor(0x67, GC2375HREAR_BLK_Select2_L);
...
UINT32 GC2375HREAR_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
